...
class DDetailsPage extends ConsumerWidget {
  DDetailsPage({Key? key, required this.getIndex}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final product = ref.watch(d_ProductNotifierprovider);
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset(product[getIndex].imageurl, fit: BoxFit.cover),
            ),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Gap(8),
                  Text(product[getIndex].long_description),
                  const Gap(12),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(
                        '\$${product[getIndex].price * product[getIndex].quantity}',
